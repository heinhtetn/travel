            ...
            <nav class="navbar navbar-expand-lg bg-light navbar-light shadow-lg py-3 py-lg-0 pl-3 pl-lg-5">
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <a href="{{ route('index.poi') }}" class="nav-item nav-link @yield('poi')">Point of
                            Interests</a>
                        <a href="{{ route('transport.show') }}"
                            class="nav-item nav-link @yield('transport')">Transportations</a>
                        <a href="{{ route('hotels.show') }}" class="nav-item nav-link @yield('hotels')">Hotels</a>
                        <a href="{{ route('blogs.show') }}" class="nav-item nav-link @yield('blogs')">Blogs</a>
                        <a href="{{ route('plan.index') }}" class="nav-item nav-link @yield('planning')">Planning</a>
                        <a href="{{ route('contact.show') }}" class="nav-item nav-link @yield('contact')">Contact</a>
                    </div>
                </div>
            </nav>
        </div>
